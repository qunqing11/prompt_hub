package com.prompt.framework.security.handle;
...
public class GlobalException {
	...
	public SaResult handlerException(NotLoginException e) {
		...
		// 返回给前端
		return SaResult.code(HttpStatus.UNAUTHORIZED);
	}
	...
	public SaResult handlerException(NotPermissionException e) {
		e.printStackTrace(); 
		return SaResult.code(HttpStatus.FORBIDDEN).setMsg("没有权限，请联系管理员授权");
	}
